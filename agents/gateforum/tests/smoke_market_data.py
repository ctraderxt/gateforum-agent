"""Smoke-test gateforum_data pure functions against live public APIs (no Condor runtime)."""
...
async def main():
    ...
    print("\n---------------- SAMPLE BRIEFING PACKET (Gate.io XAU-USDT) ----------------")
    cfg = ad.Config(market_source="gate_io", kline_limit=60)
    async with aiohttp.ClientSession() as s:
